                ...
                <div class="container">
                    <div class="row">
                        <div id="logo-bar" class="col-sm-12">
                            <div id="logo">
                                <h1><a href="{{ url('/') }}"><img
                                            src="{{ $app ? config('app.url') . 'storage/' . $app->logo_path : config('app.url') . 'images/logo.png' }} " /></a>
                                </h1>
                            </div>
                        </div>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    <ul class="nav navbar-nav">
                                        <li class="nav-item"><a href="{{ url('/') }}" class="nav-link "><span
                                                    class="data-hover" data-hover="home">home</span></a></li>

                                        <li class="nav-item"><a href="{{ url('/categories') }}"
                                                class="nav-link "><span class="data-hover"
                                                    data-hover="categories ">categories</span></a></li>

                                        <li class="nav-item"><a href="{{ url('/about') }}" class="nav-link "><span
                                                    class="data-hover" data-hover="about">about</span></a></li>

                                        <li class="nav-item"><a href="{{ url('/contact') }}" class="nav-link "><span
                                                    class="data-hover" data-hover="contact">contact</span></a></li>
                                        @auth
                                            @if (auth()->user()->is_admin)
                                                <li class="nav-item"><a href="{{ route('admin.settings') }}"
                                                        class="nav-link "><span class="data-hover"
                                                            data-hover="Admin">Admin</span></a></li>
                                            @endif
                                        @endauth
                                        @guest
                                            @if (Route::has('register'))
                                                <li class="nav-item"><a href="{{ route('register') }}"
                                                        class="nav-link "><span class="data-hover"
                                                            data-hover="sign up">{{ __('sign up') }}</span></a></li>
                                            @endif
                                            @if (Route::has('login'))

                                                <li class="nav-item"><a href="{{ route('login') }}"
                                                        class="nav-link "><span class="data-hover"
                                                            data-hover="login">{{ __('Login') }}</span></a></li>
                                        ...
                                        @else
                                            ...
                                            <li class="nav-item"><a class="nav-link " href="{{ route('logout') }}"
                                                    ...
                                                    <span class="data-hover"
                                                        data-hover="contact">{{ __('Logout') }}</span></a></li>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        ...
                        <div class="widget_content">
                            <p>{{ $app ? $app->about : 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quas, laudantium rerum! Maiores, magnam earum? Aut dicta corrupti veritatis dolor nisi exercitationem minima, quod eius autem itaque qui aliquam vel fuga.' }}
                            </p>
                            <ul class="contact-details-alt">
                                <li><i class="fa fa-user"></i>
                                    <p><strong>Phone</strong>: <a
                                            href="tel:{{ $app ? $app->business_phone : '123 123 123' }}">{{ $app ? $app->business_phone : '+2123 123 123' }}</a>
                                    </p>
                                </li>
                                <li><i class="fa fa-envelope"></i>
                                    <p><strong>Email</strong>: <a
                                            href="mailto:{{ $app ? $app->business_email : 'tauseed@test.com' }}">{{ $app ? $app->business_email : 'tauseedzaman@test.com' }}</a>
                                    </p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="widget_content">
                            <ul class="tweet_list">
                                <li class="tweet_content item">
                                    <p class="tweet_link"><a href="#">@yahooobaba </a> Lorem ipsum dolor et, consectetur
                                        adipiscing eli</p>
                    ...
                    <div class="col-sm-6 ">
                        <div class="footer_social">
                            <ul class="footbot_social">
                                ...
                                <li><a class="skype" href="#." data-placement="top" data-toggle="tooltip"
